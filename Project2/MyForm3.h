...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Location = System::Drawing::Point(447, 107);
			...
			this->label1->Location = System::Drawing::Point(447, 77);
			...
			this->panel1->Location = System::Drawing::Point(17, 66);
			...
			this->label5->Location = System::Drawing::Point(449, 353);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(475, 133);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(475, 101);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(475, 69);
			...
			this->button1->Location = System::Drawing::Point(441, 192);
			...
			this->label8->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label8->Location = System::Drawing::Point(188, 25);
			this->label8->Name = L"label8";
			this->label8->Size = System::Drawing::Size(115, 29);
			this->label8->TabIndex = 39;
			this->label8->Text = L"Эллипс:";
			// 
			// label9
			// 
			...
			this->label9->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 8, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label9->Location = System::Drawing::Point(441, 240);
			this->label9->Name = L"label9";
			this->label9->Size = System::Drawing::Size(173, 100);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(475, 165);
			this->textBox4->MaxLength = 4;
			this->textBox4->Name = L"textBox4";
			this->textBox4->Size = System::Drawing::Size(71, 26);
			this->textBox4->TabIndex = 41;
			this->textBox4->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &MyForm3::textBox4_KeyPress);
			// 
			// label10
			// 
			this->label10->AutoSize = true;
			this->label10->Location = System::Drawing::Point(447, 168);
			...
			this->ClientSize = System::Drawing::Size(617, 395);
...
private:  
	...
	System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (proverka()) {
			...
			//точка в центре
			g->DrawLine(Pens::Black, (centerX - ae / 4) * unit, centerY * unit, (centerX + ae / 4) * unit, centerY * unit);
			g->DrawLine(Pens::Black, centerX * unit, (centerY - ae / 4) * unit, centerX * unit, (centerY + ae / 4) * unit);

			//график эллипаса в полярных координатах 
			for (double theta = 0; theta <= 2 * Math::PI; theta += 0.01) {
				double r = (ae * be / Math::Sqrt(pow(be, 2) * Math::Cos(theta) * Math::Cos(theta) + pow(ae, 2) * Math::Sin(theta) * Math::Sin(theta)));
